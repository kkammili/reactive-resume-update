      ...
      items: [
        {
          ...
          summary:
            "<p>Involved in modernizing and enhancing legacy systems, including PSW and NBDB, by migrating them to Edithub using newer technologies like Angular 18. Played a key role in addressing production issues and developing new features to improve user experience.</p>",
          url: {
            label: "",
            href: "",
          },
